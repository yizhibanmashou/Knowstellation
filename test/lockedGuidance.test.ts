...
import { formatLockedFormulaReason, resolveLockedFormulaGuidance } from '../src/features/graph/lockedGuidance.ts';
import type { ChapterDependencies } from '../src/shared/types/formula.ts';
